...
export default function GitHubStats() {
  ...
  const [topRepos, setTopRepos] = useState<Repository[]>([
    {
      ...
      description: 'Modern portfolio template built with Next.js and Tailwind CSS',
      stars: 150,
      forks: 45,
      language: 'TypeScript',
    ...
    },
    {
      ...
      description: 'A beautiful admin dashboard with React and Material-UI',
      stars: 120,
      forks: 30,
      language: 'JavaScript',
      url: 'https://github.com',
    ...
    {
      name: 'nodejs-api',
      description: 'RESTful API boilerplate with Node.js, Express, and MongoDB',
      stars: 95,
      forks: 25,
      language: 'JavaScript',
      url: 'https://github.com',
  ...
  // Uncomment and modify this to fetch real GitHub data
  // useEffect(() => {
  //   const fetchGitHubData = async () => {
  //     setLoading(true);
  //     try {
  //       const username = 'mhshahzad'; // Replace with your GitHub username
  //       
  //       // Fetch user stats
  ...
  //         totalStars,
  //         contributions: 1250, // Would need GitHub GraphQL API for accurate data
  //         streak: 180, // Would need external API or calculation
  //       });
  //       
  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <a
            href="https://github.com/mhshahzad"
            target="_blank"
            rel="noopener noreferrer"
