...
type ProjectFilter = 'all' | 'featured' | 'frontend' | 'fullstack' | 'other';
                ...
                >
                    <div className="flex flex-col lg:flex-row gap-4 mb-6">
                        ...
                        <div className="relative flex-1">
                            ...
                            <input
                                type="text"
                                placeholder="Search by project name, tech stack, features..."
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className={`px-4 py-3 rounded-xl font-medium transition-all flex items-center gap-2 shadow-sm ${
