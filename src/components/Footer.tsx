      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h3 className="text-2xl font-bold">Muhammad Hamza Shahzad</h3>
          ...
          <div className="flex space-x-6">
            ...
            <a
              href="https://linkedin.com/in/mhshahzad"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-white transition-colors"
              aria-label="LinkedIn"
            ...
            <div className="text-center md:text-left">
              <p className="text-gray-400 text-sm">
                &copy; {new Date().getFullYear()} Muhammad Hamza Shahzad. All rights reserved.
              </p>
            </div>
            <div className="flex-1 text-center">
              <a
                href="https://github.com/mhshahzad/portfolio/fork"
                target="_blank"
                rel="noopener noreferrer"
